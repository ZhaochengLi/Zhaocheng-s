...
##########################################################################
### multiFit Function, used to fit models, is called twice in stacking ###
##########################################################################
...
##########################################################################
### cv.multiFit function: the improved stacking, cross validation like ###
##########################################################################
...
############################################################################
### nostacking Function, functions using to fit models without stacking  ###
############################################################################
...
#############################################################################################
### stacking function: function for stacking process to construct multi-tasking model fit ###
#############################################################################################
...
################################################################
###      MAIN SKELETON -- Program apply functions above      ###
################################################################
### CV SET-UP
set.seed(0)
...
for(ii in 1:nfold){
  ...
  #call Improved stacking with training set
  #cv-multifit use
  ######
...
#################################################
### DATA PARSING INTO RIGHT FORMAT TO ANALYZE ###
#################################################
# Improved stacking cv-multifit
#######
...
# Making dataset into executable matrix
# IMPROVED stacking cv-multifit
#######
...
#############################
##MSE (Improved Stacking cv-multifit)
###########
...
##AVE BIAS (Improved Stacking cv-multifit)
###########
...
##VARIANCE (Improved Stacking cv-multifit)
###########
